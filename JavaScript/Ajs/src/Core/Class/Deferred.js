...
Ajs.extend({
    ...
    when: function(subordinate /* , ..., subordinateN */ ) {
        var i = 0,
            ...
            remaining = length !== 1 || (subordinate && Ajs.Type.isFunction(subordinate.promise)) ? length : 0,

            // the master Deferred. If resolveValues consist of only a single Deferred, just use that.
            deferred = remaining === 1 ? subordinate : Ajs.Deferred(),
        ...
        if (length > 1) {
            ...
            for (; i < length; i++) {
                if (resolveValues[i] && Ajs.Type.isFunction(resolveValues[i].promise)) {
